...
COMMAND_DOCS: tuple[CommandDoc, ...] = (
    ...
    CommandDoc("plan", "Productivity", "Set and review daily study plans.", "-plan set/view/today", "-plan set monday Physics, Chemistry"),
    ...
    CommandDoc("resources", "Knowledge", "Share and browse study resources.", "-resources add/list/delete", "-resources add math https://...", ("resource",)),
    CommandDoc("room", "Community", "Create and manage private study rooms.", "-room create/join/leave/delete/lock/unlock", "-room create Late Night Revision"),
    ...
    CommandDoc("inventory", "Gamification", "Show the items you bought from the shop.", "-inventory", "-inventory"),
